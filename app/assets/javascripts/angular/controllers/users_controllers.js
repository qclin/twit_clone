var myApp = angular.module('twitClone', ['ngRoute', 'ngResource']);
...
myApp.controller('UserListCtr', ['$scope', '$resource', 'Users', 'User','$location', function($scope, $resource, Users, User, $location){
  $scope.users = Users.query(); //gets users collection
}]);
...
myApp.controller("UserUpdateCtr", ['$scope', '$resource', 'Users', '$location', function($scope, $resource, Users, $location) {
